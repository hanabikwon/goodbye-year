...
4. advice: 한줄 조언 (2026년을 위한 따뜻한 한마디)
5. keywords: 이 사람의 2025년을 나타내는 키워드 5개 (배열로, 답변에서 추출)
...
- 감정과 내면 (3개): 행복했던 순간, 힘들었던 순간, 가장 많이 느낀 감정
- 관계 (3개): 고마웠던 사람과 이유, 새롭게 소중해진 사람, 멀어진 사람
- 성장과 변화 (6개): 가장 큰 변화, 1년 전 나에게 하고 싶은 말, 자주 미룬 것, 포기한 것, 완주한 것, 고민 중인 것
- 나다움/취향 (12개): 보다가 만 영상, 노래, 책, 장소, 여행지, 음식, 잘한 소비, 취미, 향수, 매력 없어진 것, 길티 플레져, 버려야 할 물건
...
7. advice: 2026년 맞춤 조언 (3-4문장, 미래 계획과 연결하여)
8. keywords: 이 사람의 2025년을 나타내는 키워드 5개 (배열로)
